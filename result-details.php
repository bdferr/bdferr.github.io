<?php
/*This is a script which is called by mousing over a video search result
from the ferrerih_p4_results.php page. It provides more details
about the result, including genre, keywords, duration, color, sound and sponsor.
