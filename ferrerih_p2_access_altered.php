<?php
//Here I specify the host and which database on that host to connect to,
//along with the username and password. These are X'd out for security,
//even though my access has expired; this is just a good habit.
$h = 'pearl.ils.unc.edu';
$u = 'XXXXXXXX';
$p = 'XXXXXXXXX';
$dbname = 'XXXXXXXX_db';
