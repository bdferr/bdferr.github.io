...
<head>
    ...
    <meta name="description" content="Last modified 2/26/2016"> 
	<!-- jQuery library -->
...
echo <<<_END
	<footer class="clear">
		...
		<div>
			<ul>
				<li class="navbar"><address><a href="mailto:ferrerih@live.unc.edu">Contact Me</a></address></li>
		...
		<br />
		<div>Last updated on 2/26/2016.</div>
	</footer>
</body>
</html>
_END;
