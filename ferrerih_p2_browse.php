...
//for navigation purposes. Each full page has 25 results.
$count = 0;
...
echo <<<_END
	...
	<head>
        ...
        <meta name="description" content="Last modified 7/8/2018"> 
	...
	<div class="container">
		...
		<!--This is the button, supplied by Bootstrap, which you use to select which column to sort the results by.-->
		<div class="dropdown">
			...
			<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
				...
				<li><a href="ferrerih_p2_browse.php?sortby=itemnum&offset=$offset">Item Number</a></li>
...
if ($result)
{
	...
	if($offset == 0) 
	/*If you are on the first page of results, so the first result is visible, 
	there will be no previous or first button:*/
	{
		$nextoffset = 25;
		...
		<br />
		<div>Last updated on 7/8/2018.</div>
		</footer>
		<div>
		</body>
		</html>
_END;
	...
	//there will be no next or last button:
...
_END;
	...
	//the previous button reduces the offset by 25, the next button increases the offset by 25,
	//and there is also a button to take you to the first or last page:
	else
	{
